...
smart_lookup = dict(
    ASP06_J3="PGS_5_(ASP_06)",
    ASP06_J4="VIS_6_(ASP_06)",
    ASP06_J5="PGS_6_(ASP_06)",
    ASP06_J6="VIS_7_(ASP_06)",  # spectrometers
    J3="dw",
    J4="dw",  # direction of channel
    Fdw_SWIR="ASP06_J3",
    Fdw_VNIR="ASP06_J4",  # direction, property of channel
    Fdw="VN05",  # inlet name
...
coordinates = dict(
    ...
    Santiago=(-8.418, 42.898),
    Bergen=(5.218, 60.293),
    Torshavn=(-6.76, 62.01),
    Muenchen_Oberschleissheim=(11.55, 48.25),
...
radiosonde_stations = [
    "Torshavn_06011",
    "Muenchen_Oberschleissheim_10868",
    "Meiningen_10548",
    "Lerwick_03005",
    "Ittoqqortoormiit_04339",
    "Tasiilaq_04360",
    "Norderney_10113",
]
# long flight names
flight_names = dict(
    EMV="HALO-AC3_20220221_HALO_EMV",
    RF00="HALO-AC3_20220225_HALO_RF00",
    RF01="HALO-AC3_20220311_HALO_RF01",
    RF02="HALO-AC3_20220312_HALO_RF02",
    RF03="HALO-AC3_20220313_HALO_RF03",
    RF04="HALO-AC3_20220314_HALO_RF04",
    RF05="HALO-AC3_20220315_HALO_RF05",
    RF06="HALO-AC3_20220316_HALO_RF06",
    RF07="HALO-AC3_20220320_HALO_RF07",
    RF08="HALO-AC3_20220321_HALO_RF08",
    RF09="HALO-AC3_20220328_HALO_RF09",
    RF10="HALO-AC3_20220329_HALO_RF10",
    RF11="HALO-AC3_20220330_HALO_RF11",
    RF12="HALO-AC3_20220401_HALO_RF12",
    RF13="HALO-AC3_20220404_HALO_RF13",
    RF14="HALO-AC3_20220407_HALO_RF14",
    RF15="HALO-AC3_20220408_HALO_RF15",
    RF16="HALO-AC3_20220410_HALO_RF16",
    RF17="HALO-AC3_20220411_HALO_RF17",
    RF18="HALO-AC3_20220412_HALO_RF18",
...
take_offs_landings = dict(
    EMV=(Ts(2022, 2, 21, 10, 25), Ts(2022, 2, 21, 13, 42)),
...
stabilized_flights = list(flight_names.values())[
    :-2
]  # flights during which the stabilization was running
unstabilized_flights = list(flight_names.values())[
    -2:
]  # flights with no stabilization running
stabbi_offs = list(flight_names.values())[
    8:
]  # flights during which the stabilization was turned off in curves

radiation_square = dict(
    s_leg=(Ts(2022, 2, 25, 9, 17), Ts(2022, 2, 25, 9, 19, 45)),
